...
import { createEmergencyType, getAllEmergencyTypes, updateEmergencyType, deleteEmergencyType, getEmergencyTypeById, getEmergencyTypeByName } from '../../service/emergencyTypeService.js';
